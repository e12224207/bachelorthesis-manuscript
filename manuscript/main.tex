...
A compacted grammar for MiniProb is shown in \ref{fig:ebnf_grammar} containing the core elements providing enough understanding?>.
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \[
      \begin{array}{rcl}
        ...
        prob\_assign
         & \to  & prob\_choice\;expr                                                                                       \\[6pt]

        prob\_choice
         & \to  & \texttt{\{}\;expr\;\texttt{:}\;expr\;\texttt{\}}                                                         \\[6pt]

        logical\_or
         & \to  & logical\_and\;(\texttt{||}\;logical\_and)^*                                                              \\[6pt]

        logical\_and
         & \to  & comparison\;(\texttt{\&\&}\;comparison)^*                                                                \\[6pt]

        comparison
         & \to  & term\;(comparison\_op\;term)^*                                                                           \\[6pt]

        comparison\_op
         & \to  & \texttt{>}\;\mid\;\texttt{>=}\;\mid\;\texttt{<}\;\mid\;\texttt{<=}\;\mid\;\texttt{==}\;\mid\;\texttt{!=} \\[6pt]
      \end{array}
    \]
  \end{minipage}
  \hfill
