...
\fancypagestyle{titlepage}{%
  ...
  \renewcommand{\headrulewidth}{0pt} % no rule in the header
  \renewcommand{\footrulewidth}{0.4pt}% draw a rule above the footer
  \fancyfoot[C]{\small
    Technische Universität Wien\\
    A-1040 Wien Karlsplatz 13 \quad Tel.\ +43-1-58801-0 \quad www.tuwien.at
  }
}
\usepackage{titlesec}
...
\Title{\thesistitle}
\Language{de-AT}
\Keywords{VS Code extension\sep Langium\sep Languages\sep Language tooling}
\Publisher{TU Wien}
\Subject{Thesis}
\end{filecontents*}
...
\begin{titlepage}
  ...
  \noindent
  \includegraphics[width=0.4\textwidth]{graphics/tuWienLogo.png}
